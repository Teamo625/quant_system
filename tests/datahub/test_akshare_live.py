...
from quant.datahub.adapters.akshare import AKSHARE_SOURCE_ID, AkshareAShareDailyBarAdapter
    ...
    def test_live_akshare_daily_bars_smoke(self) -> None:
        ...
        try:
            ...
            if _is_live_environment_unavailable(exc):
                self.skipTest(
                    "live AKShare source unavailable in current environment: "
