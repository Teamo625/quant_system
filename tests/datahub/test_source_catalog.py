...
class SourceCatalogTests(unittest.TestCase):
    ...
    def test_akshare_public_source_notes_include_corporate_action_taxonomy(self) -> None:
        ...
        self.assertIn("stock_share_hold_change_sse", entry.notes)
        self.assertIn("stock_share_hold_change_szse", entry.notes)
        self.assertIn("stock_share_hold_change_bse", entry.notes)
        ...
        self.assertIn("stock_hsgt_individual_em", entry.notes)
        self.assertIn("stock_hsgt_individual_detail_em", entry.notes)
        self.assertIn("currently proven", entry.notes.lower())
        self.assertIn("attempted bounded", entry.notes.lower())
        self.assertIn("does not yet prove that fallback", entry.notes.lower())
        self.assertIn("upstream-broken", entry.notes.lower())
        self.assertNotIn("fallback coverage", entry.notes.lower())
        self.assertIn("stock_zt_pool_strong_em", entry.notes)
        self.assertIn("stock_zt_pool_sub_new_em", entry.notes)
        self.assertIn("stock_financial_report_sina", entry.notes)
        self.assertIn("stock_financial_debt_new_ths", entry.notes)
        self.assertIn("stock_financial_benefit_new_ths", entry.notes)
        self.assertIn("stock_financial_cash_new_ths", entry.notes)
        ...
        self.assertIn("index_global_name_table", entry.notes)
        self.assertIn("index_global_hist_sina", entry.notes)
        self.assertIn("20-code", entry.notes)
        self.assertIn("1000-row history window", entry.notes)
        self.assertIn("S&P 500", entry.notes)
        self.assertIn("Nasdaq Composite", entry.notes)
        self.assertIn("Dow Jones Industrial Average", entry.notes)
    ...
    def test_akshare_public_source_notes_keep_hk_cluster_limitations_explicit(self) -> None:
        ...
        self.assertIn("160706.FUND_CN", entry.notes)
        self.assertIn("161725.FUND_CN", entry.notes)
        self.assertIn("501018.FUND_CN", entry.notes)
        self.assertIn("return empty", entry.notes)
        ...
        self.assertNotIn("BaoStock", entry.notes)
