...
DEFAULT_REQUIRED_SOURCE_CAPABILITIES: tuple[SourceCapability, ...] = (
    ...
    SourceCapability(
        ...
        gap_reason="No stable intraday dataset contract exists in DatasetName.",
        recommended_handoff_theme="introduce minute-bars dataset contract and adapter interface",
    ),
    SourceCapability(
    ...
    SourceCapability(
        ...
        source_family_ids=("tushare_pro_cn_core",),
        status=CapabilityStatus.MISSING,
        gap_reason="No stable dataset contract exists for margin and securities lending metrics.",
        recommended_handoff_theme="define margin-financing/lending contracts and adapter slice",
    ),
    SourceCapability(
        ...
        gap_reason="Credentialed source family exists but no stable DatasetName contract is defined yet.",
        recommended_handoff_theme="add financial-statement dataset contracts and source adapter",
    ),
    SourceCapability(
        ...
        source_family_ids=("tushare_pro_cn_core",),
        status=CapabilityStatus.PLANNED,
        gap_reason="Credentialed source family is listed but indicator contract/output is not implemented.",
        recommended_handoff_theme="define financial-indicator contracts and adapter output schema",
    ),
    SourceCapability(
    ...
    SourceCapability(
        ...
        source_family_ids=("tushare_pro_cn_core",),
        status=CapabilityStatus.MISSING,
        gap_reason="No dedicated dataset contract for major activity event families.",
        recommended_handoff_theme="introduce major-activity event contracts and capability mapping",
    ),
    SourceCapability(
    ...
    SourceCapability(
        ...
        source_family_ids=("akshare_cn_hk_public_family",),
        status=CapabilityStatus.MISSING,
        gap_reason="No stable HK-specific financial dataset contracts are currently defined.",
        recommended_handoff_theme="add HK financial statement/indicator contracts and adapters",
    ),
    SourceCapability(
    ...
    SourceCapability(
        ...
        source_family_ids=("akshare_cn_hk_public_family", "tushare_pro_cn_core"),
        status=CapabilityStatus.PARTIAL,
        gap_reason="Holdings contract exists but coverage window and refresh rhythm are narrow.",
        recommended_handoff_theme="fund holdings cadence and breadth enhancement",
    ),
    SourceCapability(
    ...
    SourceCapability(
        ...
        source_family_ids=("tushare_pro_cn_core",),
        status=CapabilityStatus.MISSING,
        gap_reason="No stable dataset contract exists for ETF/fund flow metrics.",
        recommended_handoff_theme="introduce fund-flow contracts and source adapter",
    ),
    SourceCapability(
