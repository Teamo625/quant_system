...
DEFAULT_SOURCE_CATALOG_ENTRIES: tuple[SourceCatalogEntry, ...] = (
    ...
    SourceCatalogEntry(
        ...
        notes=(
            ...
            "broader listed-fund/LOF market-price coverage across multiple "
            "proven FUND_CN codes such as 160706.FUND_CN, 161725.FUND_CN, "
            "and 501018.FUND_CN through fund_lof_hist_em with bounded "
            "fund_etf_hist_sina fallback history, but some listed-fund codes "
            "still fail or return empty at source, off-exchange fund daily-"
            "bar breadth, and independent public-route redundancy remain "
            "unproven. "
            ...
            "fund_etf_fund_info_em, and broader listed-fund/LOF FUND_CN "
            "coverage such as 160706.FUND_CN, 161725.FUND_CN, and "
            "501018.FUND_CN through fund_open_fund_info_em, but some listed-"
            "fund codes still fail or return empty at source, off-exchange "
            "fund support, and independent direct public premium-discount "
            "redundancy remain unproven. ETF/fund scale/share proof "
            ...
            "rows plus stock_dzjy_mrtj symbol-date summary rows, and "
            "bounded per-symbol insider holding-change history through "
            ...
            "through the currently proven stock_hsgt_individual_em route; TASK-132 "
            "also implemented an attempted bounded stock_hsgt_individual_detail_em "
            "fallback for holding/value/A-share-ratio facts, but current live "
            "evidence does not yet prove that fallback because the route is "
            "upstream-broken and the primary route appears stale for recent "
            "bounded windows. Eastmoney-backed stock_zh_a_hist daily "
            ...
            "is stale through 2022-07-13; the undated comparison snapshot "
            "route still cannot safely satisfy the dated history contract, "
            "and current-dated redundancy is still unproven. HK financial proof currently uses "
            ...
            "income and shareholder-profit fields, but accepted live proof "
            "still centers on sampled liquid issuers; broader HK issuer "
            ...
            "source-route truth, plus the full currently advertised 20-code "
            "non-US global benchmark table through "
            "index_global_name_table/index_global_hist_sina. The accepted "
            "global public slice is still limited to the route's recent "
            "1000-row history window, and the published AKShare table does "
            "not include S&P 500, Nasdaq Composite, or Dow Jones Industrial "
            "Average history; independent public-route redundancy and broader "
            "HK index families also remain unproven. HK corporate-actions proof currently "
            "covers caller-provided bounded multi-symbol "
            "stock_hk_dividend_payout_em dividend/distribution "
            "implementation history plus same-family "
            "stock_hk_fhpx_detail_ths dividend-plan and explicit "
            "no-distribution decision history; broader HK split/rights/"
            "consolidation taxonomy and independent route redundancy remain unproven. "
            ...
            "turnover-rate, float-share, spread, and other deeper liquidity facts "
            "are not source-validated yet. "
            ...
            "sampling. Bounded list metadata can skip obvious ETF/fund/index "
            "rows when the route exposes those hints, but no proven no-credential "
            "HK non-stock taxonomy or dated delist/inactive lifecycle route is "
            "catalog-validated yet. "
