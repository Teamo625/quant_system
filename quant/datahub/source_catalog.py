...
DEFAULT_SOURCE_CATALOG_ENTRIES: tuple[SourceCatalogEntry, ...] = (
    ...
    SourceCatalogEntry(
        ...
        notes=(
            ...
            "Eastmoney kline fallback, limited recent stock_zh_a_minute "
            "fallback, and BaoStock 5/15/30/60-minute history; older "
            "1-minute continuity and deeper public-source redundancy remain "
            "unproven. "
            ...
            "turnover/liquidity facts. A-share valuation proof currently "
