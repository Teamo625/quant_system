...
DEFAULT_SOURCE_CATALOG_ENTRIES: tuple[SourceCatalogEntry, ...] = (
    ...
    SourceCatalogEntry(
        ...
        notes=(
            ...
            "source-route truth, but broader HK index families, global index "
            "history, and independent public-route redundancy remain "
            "unproven. HK corporate-actions proof currently "
