...
DEFAULT_SOURCE_CATALOG_ENTRIES: tuple[SourceCatalogEntry, ...] = (
    ...
    SourceCatalogEntry(
        ...
        notes=(
            ...
            "listed-fund/LOF daily bars through fund_lof_hist_em, and bounded "
            "fund_etf_hist_sina fallback history for both listed route families, "
            "but off-exchange fund daily-bar breadth and independent public-route "
