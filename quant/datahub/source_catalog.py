...
DEFAULT_SOURCE_CATALOG_ENTRIES: tuple[SourceCatalogEntry, ...] = (
    ...
    SourceCatalogEntry(
        ...
        notes=(
            ...
            "turnover/liquidity facts. HK daily-bar proof currently uses "
            "stock_hk_hist bounded windows with stock_hk_daily full-history "
            "fallback filtering inside the same AKShare family, so independent "
            "public-source redundancy is still unproven. HK instrument-master proof is currently "
