...
DEFAULT_SOURCE_CATALOG_ENTRIES: tuple[SourceCatalogEntry, ...] = (
    ...
    SourceCatalogEntry(
        ...
        notes=(
            ...
            "unproven. ETF/fund scale/share proof now has a dedicated adapter-"
            "backed normalized path through bounded exchange ETF share history "
            "from fund_etf_scale_sse and fund_scale_daily_szse plus latest "
            "dated per-fund snapshot scale/share facts from fund_scale_open_sina "
            "and fund_scale_close_sina, but structured/other fund families, "
            "clear raised-scale unit semantics, caller-parameterized snapshot "
            "routing, and independent public-route redundancy remain incomplete. "
