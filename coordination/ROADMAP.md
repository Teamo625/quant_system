...
- TASK-122 is dispatched as the next Phase 2.5-P DataHub hardening task for ETF/fund scale/share canonical schema truth. It must add a first-class ETF/fund scale/share source-fact contract and reconcile `fund_scale_and_share` capability/source metadata without promoting beyond source-backed evidence.
