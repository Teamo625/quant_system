...
- TASK-125 is dispatched as the next executable Phase 2.5-P DataHub hardening task for `fund_premium_discount` breadth and history. It must prove stronger stable no-credential public ETF/fund premium-discount history/breadth where feasible, or truthfully constrain capability/source wording without promotion.
