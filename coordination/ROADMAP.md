...
- TASK-108 is dispatched as the next executable TASK-093 queue item: A-share company-announcement breadth and history hardening for `DatasetName.COMPANY_ANNOUNCEMENTS` where stable no-credential public routes expose source truth.
