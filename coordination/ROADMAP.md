...
- TASK-098 is active as the next unclosed TASK-093 queue item. It targets `a_share_corporate_actions`, whose current non-pass reason is that breadth across split/dividend/rights event families remains incomplete.
