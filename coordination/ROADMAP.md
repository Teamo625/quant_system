...
- TASK-088 is dispatched to harden public index `INDEX_DAILY_BARS` access from a one-index slice to caller-provided multi-index bounded benchmark daily-bar access with default offline-safe tests and gated live smoke evidence.
