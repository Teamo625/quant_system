...
- TASK-045 is dispatched as the next Phase 2.5 task: implement a narrow public AKShare A-share margin financing/lending adapter slice with offline tests and gated live smoke.
