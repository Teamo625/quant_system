...
- TASK-082 is dispatched for ETF/fund `DAILY_BARS` batch/date-window hardening, starting the TASK-071 ETF/fund queue for daily/NAV/holdings/flow breadth and history gaps.
