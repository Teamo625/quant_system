...
- TASK-113 is dispatched as the next Phase 2.5-P DataHub hardening task continuing the unresolved `hk_universe_reference` item: prove source-backed HK non-stock taxonomy and dated lifecycle/listing-status truth if stable no-credential routes exist, or truthfully constrain capability/source wording without promotion.
