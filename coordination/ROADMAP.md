...
- TASK-086 is dispatched as a contract-only handoff for ETF/fund premium-discount source facts because `fund_premium_discount` still lacks a dedicated validated DataHub contract target.
