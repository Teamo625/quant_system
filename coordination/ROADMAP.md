...
- TASK-123 is active as the next Phase 2.5-P DataHub hardening task. It continues `fund_scale_and_share` by requiring no-credential public ETF/fund scale/share source breadth/history hardening where feasible, or truthful capability/source constraint without promotion if stronger public routes are not feasible.
