...
- TASK-126 is dispatched as the next Phase 2.5-P DataHub hardening handoff for `index_daily_bars` breadth and benchmark coverage. It must prove stronger stable no-credential China/HK/global benchmark daily-bar breadth, longer continuity, or source-route truth where public routes expose it, or truthfully constrain capability/source wording without promotion.
