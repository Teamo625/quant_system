...
- TASK-104 is dispatched as the next executable TASK-093 queue item: A-share limit-up/down breadth and history hardening for `DatasetName.LIMIT_UP_DOWN_EVENTS` where stable no-credential public routes expose source truth.
