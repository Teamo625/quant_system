...
- TASK-078 is dispatched for A-share `MINUTE_BARS` batch/date-window hardening, continuing the TASK-071 short-term A-share research gap queue for intraday source access.
