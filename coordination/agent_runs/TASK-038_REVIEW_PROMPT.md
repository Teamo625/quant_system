...
完成后请告知，并按照如下格式输出内容（作为另一角色的提示词），写入这轮 coordination/handoffs/TASK-038_DATAHUB_AKSHARE_ETF_DAILY_BAR_ADAPTER.md、coordination/reports/TASK-038_REPORT.md 和 coordination/reviews/TASK-038_REVIEW.md 的名称：
你是Integration Agent。
请读取：
- AGENTS.md
- coordination/CONTEXT_SNAPSHOT.md
